<!-- .site-footer -->
      <footer class="site-footer wrapper" role="contentinfo"> 
        ...
        <div class="row">
          ...
          <div id="supplementary" class="row-fluid">
            ...
            <!--<div class="widget-area span3" role="complementary">
              ...
              <aside class="widget widget_text">
                ...
                <div class="textwidget">Bloggy is a minimalistic wordpress theme focused on readability. This is a just text widget with some dummy content. This is a just text widget with some dummy content. This is a just text widget with some dummy content.</div>
              </aside>
          ...
          <!-- .site-info -->
          <div class="site-info">Copyright&copy {{ date('Y') }} Koonema</div>
          <!-- .site-info --> 
